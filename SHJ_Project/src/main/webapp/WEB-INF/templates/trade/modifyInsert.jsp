...
<div class="container wrap">
	<div class="text-center">
		<h2 class="section-heading">게시글 수정</h2>
		...
		<table class="table" style="max-width: 700px">		
			...
			<tr>
				...
				<td align="left"><img src="${pageContext.request.contextPath}/resource/upload/${selectDetailTrade.picture }" style="max-width: 200px; height: 100px;">
				<input type="file" class="btn" id="file" name="file" accept="image/png, image/jpeg"></td>
			</tr>
			<tr>
				<th style="padding:13px 0 0 15px" width="100">제목</th>
				<td align="left"><input name="title" class="col-md-1 form-control input-sm" type="text" size="52" value="${selectDetailTrade.title }"/></td>
			</tr>
			<tr>
				<th style="padding:13px 0 0 15px" width="100">가격</th>
				<td align="left"><input name="price" class="col-md-1 form-control input-sm" type="text" size="52" value="${selectDetailTrade.price }"/></td>
			</tr>
			<tr>
				<th style="padding:13px 0 0 15px">내용</th>
				<td align="left"><textarea name="content" class="col-md-1 form-control input-sm" cols="40" rows="5">${selectDetailTrade.content }</textarea></td>
			</tr>	
		</table>
		</form>
		<div class="pull-left">
