...
<div class="container">	
	...
	<h2 class="section-heading">전체 문의 내역</h2>
			...
			<table class="table">
				...
				<tbody>
					<c:forEach var="qnaList" items="${qnaList }">	
						...
						onclick="location.href='userQna.do?qnaBoardNo=${qnaList.qnaBoardNo}'">
							<td>${qnaList.qnaBoardNo}</td>
							<td>${qnaList.qnaTitle}</td>
							<td><fmt:formatDate value="${qnaList.qnaWdate}" pattern="yyyy-MM-dd"/></td>
							<td>${qnaList.memberId}</td>
							<td>${qnaList.qnaCheck}</td>
						</tr>
					</c:forEach>
				</tbody>					
			</table>
