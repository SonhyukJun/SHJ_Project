	...
	<div class="text-center">
		...
		<table class="table" style="max-width: 700px">		
			...
			<tr>
				...
				<td align="left"><textarea id="replyContent" name="replyContent" style="background: white" class="col-md-1 form-control input-sm" cols="40" rows="5">${replyView.replyContent }</textarea></td>
			</tr>
		</table>
    	...
    	<div class="pull-right">   	
    		<input type="button" class="btn btn-primary" value="수정" onclick="replyModify()"/>   	
    	</div>
    	</form>
	</div>	
</div>
