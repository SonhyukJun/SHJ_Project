	...
	<div class="text-center">
		...
		<table class="table" style="max-width: 700px">		
			...
			<tr>
				...
				<td align="left"><textarea id="replyContent" name="replyContent" style="background: white" class="col-md-1 form-control input-sm" cols="40" rows="5"></textarea></td>
			</tr>
		</table>
		<div class="pull-left">
    	...
    	<div class="pull-right">
    		<input type="button" onclick="replyInsert()" class="btn btn-primary" value="작성"/>
    	</div>
    	</form>
	</div>	
</div>
