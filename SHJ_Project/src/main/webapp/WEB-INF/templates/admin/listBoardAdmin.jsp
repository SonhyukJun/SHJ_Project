...
<div class="container">	
	...
	<h2 class="section-heading">게시글 조회</h2>
			...
			<table class="table">
				<thead>
					<tr>
						...
						<th style="max-width: 200px">작성날짜</th>
						<th style="max-width: 100px">가격</th>
						<th style="max-width: 100px">거래현황</th>
						<th style="max-width: 100px">작성자</th>
				...
				<nav aria-label="Page navigation" style="text-align: center;">			
					<ul class="pagination justify-content-center">
						<c:if test="${firstPage > pageList }">
							<li><a class="page-link" href="listBoardAdmin.do?viewPage=${firstPage - pageList}">이전</a></li>
						</c:if>	
						<c:forEach var="i" begin="${firstPage}" end="${lastPage}">																
							<li><a class="page-link" href="listBoardAdmin.do?viewPage=${i}">${i}</a></li>
						</c:forEach>
						<c:if test="${lastPage < totalPage}">
							<li><a class="page-link" href="listBoardAdmin.do?viewPage=${firstPage + pageList}">다음</a></li>
						</c:if>
					</ul>		
				</nav> 
			</div>
